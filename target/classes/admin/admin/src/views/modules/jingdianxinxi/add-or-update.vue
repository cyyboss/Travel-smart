<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="每天开放时间" prop="meitiankaifangshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.meitiankaifangshijian" 
                type="datetime"
                placeholder="每天开放时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.meitiankaifangshijian" label="每天开放时间" prop="meitiankaifangshijian">
              <el-input v-model="ruleForm.meitiankaifangshijian" 
                placeholder="每天开放时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="每天关闭时间" prop="meitianguanbishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.meitianguanbishijian" 
                type="datetime"
                placeholder="每天关闭时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.meitianguanbishijian" label="每天关闭时间" prop="meitianguanbishijian">
              <el-input v-model="ruleForm.meitianguanbishijian" 
                placeholder="每天关闭时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	suozaidiqu : false,
	meitiankaifangshijian : false,
	meitianguanbishijian : false,
	beizhu : false,
	jiage : false,
	tupian : false,
	thumbsupnum : false,
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.suozaidiqu = true;
          ...
          if(o=='meitiankaifangshijian'){
            this.ruleForm.meitiankaifangshijian = obj[o];
	    this.ro.meitiankaifangshijian = true;
            continue;
          }
          if(o=='meitianguanbishijian'){
            this.ruleForm.meitianguanbishijian = obj[o];
	    this.ro.meitianguanbishijian = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.jingdiandengjiOptions = "A,B,C,D".split(',')
            this.$http({
