<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="交通工具名称" prop="techanmingcheng">
          <el-input v-model="ruleForm.techanmingcheng"
              placeholder="交通工具名称" clearable  :readonly="ro.techanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="交通工具名称" prop="techanmingcheng">
              <el-input v-model="ruleForm.techanmingcheng"
                placeholder="交通工具名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="交通工具介绍" prop="techanjieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.techanjieshao" label="交通工具介绍" prop="techanjieshao">
