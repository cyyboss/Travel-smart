<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="省区" prop="shengqu">
          <el-input v-model="ruleForm.shengqu" 
              placeholder="省区" clearable  :readonly="ro.shengqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="省区" prop="shengqu">
              <el-input v-model="ruleForm.shengqu" 
                placeholder="省区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='shengqu'){
            this.ruleForm.shengqu = obj[o];
	    this.ro.shengqu = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shengqu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shengquCrossAddOrUpdateFlag = false;
                  this.parent.search();
